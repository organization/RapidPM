...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getSignedShort) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&temp);
	zephir_array_fetch_long(&temp, &_3, 1, PH_NOISY, "pocketmine/utils/binarystream.zep", 135 TSRMLS_CC);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getLShort) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 146 TSRMLS_CC);
	RETURN_CTOR(&_4);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getSignedLShort) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&temp);
	zephir_array_fetch_long(&temp, &_3, 1, PH_NOISY, "pocketmine/utils/binarystream.zep", 151 TSRMLS_CC);
	RETURN_MM_LONG((((zephir_get_intval(&temp) << 48)) >> 48));
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getTriad) {
	...
	zephir_check_call_status();
	zephir_array_fetch_long(&_6, &_5, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 162 TSRMLS_CC);
	RETURN_CTOR(&_6);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getLTriad) {
	...
	zephir_check_call_status();
	zephir_array_fetch_long(&_6, &_5, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 172 TSRMLS_CC);
	RETURN_CTOR(&_6);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getInt) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&temp);
	zephir_array_fetch_long(&temp, &_3, 1, PH_NOISY, "pocketmine/utils/binarystream.zep", 182 TSRMLS_CC);
	RETURN_MM_LONG((((zephir_get_intval(&temp) << 48)) >> 48));
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getLInt) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&temp);
	zephir_array_fetch_long(&temp, &_3, 1, PH_NOISY, "pocketmine/utils/binarystream.zep", 193 TSRMLS_CC);
	RETURN_MM_LONG((((zephir_get_intval(&temp) << 48)) >> 48));
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getFloat) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 204 TSRMLS_CC);
	RETURN_CTOR(&_4);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getRoundedFloat) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 209 TSRMLS_CC);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getLFloat) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 219 TSRMLS_CC);
	RETURN_CTOR(&_4);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getRoundedLFloat) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 224 TSRMLS_CC);
	ZVAL_LONG(&_1, accuracy);
	zephir_round(return_value, &_4, &_1, NULL TSRMLS_CC);
	RETURN_MM();
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getDouble) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 234 TSRMLS_CC);
	RETURN_CTOR(&_4);
...
PHP_METHOD(Pocketmine_Utils_BinaryStream, getLDouble) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 17, &_2, &_0);
	zephir_check_call_status();
	zephir_array_fetch_long(&_4, &_3, 1, PH_NOISY | PH_READONLY, "pocketmine/utils/binarystream.zep", 244 TSRMLS_CC);
	RETURN_CTOR(&_4);
...
/**
 */
void zep_Pocketmine_Utils_BinaryStream_getOffset_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
/**
 */
void zep_Pocketmine_Utils_BinaryStream_getBuffer_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_setOffset_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *offset_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_reset_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * Rewinds the stream pointer to the start.
 */
void zep_Pocketmine_Utils_BinaryStream_rewind_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @throws BinaryDataException if there are not enough bytes left in the buffer
 */
void zep_Pocketmine_Utils_BinaryStream_get_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *len_param_ext) {
 ...
 * @throws BinaryDataException
 */
void zep_Pocketmine_Utils_BinaryStream_getRemaining_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_put_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *str_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getBool_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putBool_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getByte_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putByte_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_getSignedShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getLShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_getSignedLShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putLShort_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getTriad_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putTriad_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getLTriad_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putLTriad_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getLInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putLInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_getRoundedFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *accuracy_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_putFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getLFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_getRoundedLFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *accuracy_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_putLFloat_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getDouble_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putDouble_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
...
void zep_Pocketmine_Utils_BinaryStream_getLDouble_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
...
void zep_Pocketmine_Utils_BinaryStream_putLDouble_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int $v
 */
void zep_Pocketmine_Utils_BinaryStream_putLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getLLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int $v
 */
void zep_Pocketmine_Utils_BinaryStream_putLLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getUnsignedVarInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int $v
 */
void zep_Pocketmine_Utils_BinaryStream_putUnsignedVarInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getVarInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int $v
 */
void zep_Pocketmine_Utils_BinaryStream_putVarInt_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getUnsignedVarLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int $v
 */
void zep_Pocketmine_Utils_BinaryStream_putUnsignedVarLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return int
 */
void zep_Pocketmine_Utils_BinaryStream_getVarLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {
 ...
 * @param int
 */
void zep_Pocketmine_Utils_BinaryStream_putVarLong_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *v_param_ext) {
 ...
 * @return bool
 */
void zep_Pocketmine_Utils_BinaryStream_feof_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used) {

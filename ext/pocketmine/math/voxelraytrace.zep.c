...
PHP_METHOD(Pocketmine_Math_VoxelRayTrace, betweenPoints) {
	...
	if (ZEPHIR_IS_LONG(&_11, 0)) {
		...
		div_function(&tDeltaX, &stepX, &_12 TSRMLS_CC);
	}
	...
	if (ZEPHIR_IS_LONG(&_12, 0)) {
		...
		div_function(&tDeltaY, &stepY, &_13 TSRMLS_CC);
	}
	...
	if (ZEPHIR_IS_LONG(&_13, 0)) {
		...
		div_function(&tDeltaZ, &stepZ, &_14 TSRMLS_CC);
	}
 ...
 * @return \Generator|Vector3[]
 */
void zep_Pocketmine_Math_VoxelRayTrace_inDirection_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *start_ext , zval *directionVector_ext , zval *maxDistance_param_ext) {
 ...
 * Spaceship operator
 */
void zep_Pocketmine_Math_VoxelRayTrace_spaceShip_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *a_ext , zval *b_ext ) {
 ...
 * @return \Generator|Vector3[]
 */
void zep_Pocketmine_Math_VoxelRayTrace_betweenPoints_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *start_ext , zval *end_ext ) {
 ...
 * @return float Distance along the ray trace that must be travelled to cross a boundary.
 */
void zep_Pocketmine_Math_VoxelRayTrace_rayTraceDistanceToBoundary_zephir_internal_call(int ht, zval *return_value, zval *this_ptr, int return_value_used, zval *s_param_ext, zval *ds_param_ext) {
